...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$all_voted) {
        $error = 'Please select one candidate for each position before submitting.';
    } else {
        // Verify each candidate belongs to correct position
        $valid = true;
        ...
        <div class="position-section">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="badge badge-info">Choose 1</span>
                </div>
